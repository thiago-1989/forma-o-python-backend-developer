...
def listar_clientes_sqlite(cursor_sqlite):
...
# Argumentos para 01 - Explorando Banco de Dados Relacionais com Python DB API mysql
...
# Argumentos para 01 - Explorando Banco de Dados Relacionais com Python DB API sqlite
db_path = ROOT_PATH / "meu_banco.sqlite"

# Conectando aos bancos de dados
conexao_mysql = conectar_mysql(host, user, passwd, database)
conexao_sqlite = conectar_sqlite(db_path)
