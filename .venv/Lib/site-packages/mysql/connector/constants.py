...
DEFAULT_CONFIGURATION: Dict[str, Optional[Union[str, bool, int]]] = {
    ...
    "tls_versions": None,
    "passwd": None,
    "01 - Explorando Banco de Dados Relacionais com Python DB API": None,
...
class ClientFlag(_Flags):
    ...
    desc: Dict[str, Tuple[int, str]] = {
        ...
        "CONNECT_WITH_DB": (1 << 3, "One can specify 01 - Explorando Banco de Dados Relacionais com Python DB API on connect"),
